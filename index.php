<!-- Yg recode ga ngotak, recode dosa anjg Haram:v -->
<!-- Subscribe Channel Yt SkyXploits -->
<!-- Script By SkyXploit -->
<html>
<head>
<link href='http://fonts.googleapis.com/css?family=Fauna+One' rel='stylesheet' type='text/css'>
<link rel='shortcut icon' href='https://h.top4top.io/p_2181tuhsx0.jpg'></link>
<meta property="og:title" content="Locked SkyXploit">
<meta property="og:description" content="~ SkyXploit ~">
<meta property="og:author" content="T-BAG">
...
<meta name="keywords" content=" | [ "Hacked By SkyXploit" ]
<meta HTTP-EQUIV="Content-Type" content="text/html; charset=iso-8859-1" />
<meta name="description" content=" | Garuda Cyber Army | "><script type="text/javascript">
//<![CDATA[
...
<title> | [ "Hacked By SkyXploit"   ] | </title>
...
<body bgcolor="#000" marginwidth="0" marginheight="0" style="background: black url(../i60.tinypic.com/2j61oph.png) no-repeat center center fixed; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size:cover;" onload="pesan();type_text()" bottommargin="0" rightmargin="0" leftmargin="0" topmargin="0">
<style>
body{
...
<body onselectstart="return false" ondragstart="return false" oncontextmenu="return false" onload="pesan() img()">
<div class="xBody" id="xBody" onclick="pesan()">
<div id="ssh">
<div class="sshBox" id="sshBox">
<div class="sshHead">
[ Kalilinux ]</div>
<div id="1ssh">
<span id="mytext1">helloworld__</span><br>
<div id="ssh2" class="ssh">
Enter Password:<span id="mytext2"> default </span></div>
<div id="ssh3" class="ssh">
[root@GarudaCyberArmy]# <span id="mytext3">Last login: c_time </span></div>
<div id="ssh4" class="ssh">
[root@GarudaCyberArmy]# <span id="mytext4" style="color:#28FE14;">Gagal masuk ! <- Error ??? -></span></div>
</br> </br>
<div id="ssh5" class="ssh" style="font-size:300%;" align="center">
<span id="mytext5">[ WEBSITE TERNODAI BY SkyXploit]</span></div>
<br>
<div id="ssh5" class="ssh" style="font-size:280%;" align="center">
<span id="mytext5">https://youtube/c/SkyXploit<---- Subscribe:)</span></div>
<br>
<div id="ssh6" class="ssh">
[root@GarudaCyberArmy]# <span id="mytext6"> Login berhasil...  </span></div>
</div>
<br>
<div id="2ssh">
<div id="ssh7" class="ssh">
[root@GarudaCyberArmy]# <span id="mytext7"><center> <img src="https://b.top4top.io/p_2111k3jd30.png" width="20" height="20">
<h1>
  | [ HACKED BY SkyXploit] | </h1>
<center><h2>Thanks To</h2><br>~ Mr SadBoy X-404 ~ Sky Hunter ~ Mr.Rius~ Mr.Rans ~ Tn. Lars ~ R666X-909 ~ Kang Plastiq ~ Mr.R07 ~ THE XXX~ VICTIM-BE455 - Luffyy ~ DLL~</center>

</center><br>
[root@GarudaCyberArmy]# Message<br>
...[ Leave what is not there and focus on what is in front, because looking ahead is much better than looking back, but we can look back every now and then to see our mistakes and make those mistakes as our lessons for the future :) ]...<br>
<br> <br></span></div>
<div id="ssh5" class="ssh" style="font-size:280%;" align="center">
<span id="mytext5">Kalilinux</span></div>
<center>
<br><p>
</div>
</center>
<div id="ssh10" class="ssh" style="padding-left:5px;">
[root@magelang# <span id="mytext10">Demands ---> <br>
</span></div>
</div>
</div>
</div>
...
<canvas id="c" height="350" width="350"></canvas> <script>
        ...
        setInterval(draw, 1);
      </script> </font></font></font></font></font></font></font>
   </center>
<!-- --------Cursor--------- -->
<iframe widllth="0%" height="0" scrolling="no" frameborder="no" loop="true" allow="autoplay" src="https://a.top4top.io/m_1614l5uks0.mp3"></iframe>
